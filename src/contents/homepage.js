  ...
  return (
    ...
    >
      <motion.div className="homepage-left">
        <motion.div variants={intro1}>
          <img src="welcome.svg" className="w-14 h-14 md:w-28 md:h-28" />{" "}
        </motion.div>
        <motion.div
          variants={intro2}
        ...
        <motion.div variants={intro3} className="text-2xl md:text-3xl mb-6">
          <Typewriter
            words={[
              "I'm a Full Stack Developer",
              "I use React, Node, React Native and MongoDB",
              "I build mobile apps with React Native",
              "I craft clean UIs with Tailwind CSS",
              "I integrate RESTful APIs seamlessly",
              "I write clean, scalable JavaScript",
              "I love building modern digital products",
        ...
        <motion.p variants={intro4} className="text-lg mb-3">
          {" "}
          Discover my diverse portfolio! With a wealth of personal projects and
          internship programs under my belt, I've gathered extensive experience
          in software development. I assure you that my skills are guaranteed to
          meet your satisfaction.
        </motion.p>
        <motion.div
          variants={intro5}
          className="flex justify-between bg-blue-50 p-2 rounded-lg"
        >
          <a href="https://github.com/Leta-Asefa">
            <img src="github-142-svgrepo-com.svg" className="w-8 h-8" />
          </a>
          <a href="https://www.linkedin.com/in/leta-asefa-709790359/">
            <img src="linkedin-svgrepo-com.svg" className="w-8 h-8" />
          </a>
          <a href="https://t.me/letaasefa">
            <img src="telegram-svgrepo-com.svg" className="w-8 h-8" />
          </a>
          <a href="mailto:letaassefa7@gmail.com">
      ...
      <motion.div className="homepage-right">
        <motion.img
          ...
          src="OpO5.gif"
          className="mx-auto transofrm   opacity-100 "
        />

        <motion.div className="absolute top-0 left-0 mx-auto w-full">
          <motion.img
            src="profilepic.svg"
            className="mx-auto w-80 z-20  rounded-full"
            variants={image}
          />
